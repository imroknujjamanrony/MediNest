...
//   const { data, isLoading, isError, refetch } = useGetDoctorByIdQuery(id) as {
//     data?: DoctorResponse;
//   };
...
//             <Info label="Email" value={data.email ?? data.userId} />
...
//               value={`${data.consultationFee} BDT`}
//             />
//             <Info
//               label="Status"
//               value={
...
export default function DoctorDetails({ id }: { id: string }) {
  // Remove the type assertion - let TypeScript infer the correct type
